...
import { EventDetailComponentTypes } from './editevent.types'
...
const EditEventView = (props: EventDetailComponentTypes) => {
  const { componentId } = useStateContext<NavigationComponentProps>()
  const conf = useGetFormAttributes('EDIT_EVENT')
      ...
      Content={
        <ScrollView>
          <View center marginT-20 paddingH-15>
            ...
            <View row spread paddingT-10 style={styles.allPost} width={'100%'} paddingH-10>
              <View bg-black br30>
