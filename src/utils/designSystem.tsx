import { StatusBarStyle as ExpoStatusBarStyle, setStatusBarStyle } from 'expo-status-bar'
...
export class DesignSystem {
  ...
  static async configure(): PVoid {
    ...
    Typography.loadTypographies({
      ...
      smallest: { fontSize: moderateScale(theme.fontSize.extraVSmall) },
      extraVSmall: { fontSize: moderateScale(theme.fontSize.extraVSmall) },
      extraSmall: { fontSize: moderateScale(theme.fontSize.extraSmall) },
      small: { fontSize: moderateScale(theme.fontSize.small) },
      mediumSize: { fontSize: moderateScale(theme.fontSize.medium) },
      large: { fontSize: moderateScale(theme.fontSize.large) },
      regularSize: { fontSize: moderateScale(theme.fontSize.regular) },
      extraLarge: { fontSize: moderateScale(theme.fontSize.extraLarge) },
      heading: { fontSize: moderateScale(theme.fontSize.headingSize) },
      ...fontFamilies,
    })

    ThemeManager.setComponentTheme('Text', {
      headingBlue: true, // will set the text70 typography modifier prop to be true by default
    })
